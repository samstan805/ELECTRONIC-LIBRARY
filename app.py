...
print(f"Templates in folder: {os.listdir(TEMPLATE_FOLDER) if os.path.exists(TEMPLATE_FOLDER) else 'N/A'}")
...
if app.secret_key == "dev_secret_change_me":
    # Helpful runtime warning in dev; safe to remove in production
    print("Warning: using development SECRET_KEY. Set SECRET_KEY environment variable in production.")
...
>>>>>>> 1212344 (Add render.yaml config and debug paths)
import os
import sqlite3
from functools import wraps
from flask import (Flask, render_template, request, redirect, url_for,
